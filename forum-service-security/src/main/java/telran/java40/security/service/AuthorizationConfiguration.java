...
public class AuthorizationConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception{
		...
		http.sessionManagement()
								.sessionCreationPolicy(SessionCreationPolicy.STATELESS);//for cookies
		http.addFilterAfter(expiredFilter, BasicAuthenticationFilter.class);
...
//									.access("@customSecurity.checkExpPassword(authentication)")								
							    ...
							    .anyRequest()
							    	.authenticated();
								//for authentication to all endpoints
